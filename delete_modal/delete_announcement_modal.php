<!-- id_announcement -->
<div class="modal fade" id="deleteModal-id_announcement<?=$value['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content shadow">
        ...
        <div class="modal-footer">
            ...
            <form action='func.php'  method="post">
                <input type='hidden' name='id_announcement' value="<?=$value['id'] ?>" />
